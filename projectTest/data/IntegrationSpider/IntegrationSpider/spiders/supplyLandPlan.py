...
class supplyLandPlanSpider(CrawlSpider):
    ...
    def __init__(self):
        ...
        pathPage = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'Data/DatasupplyLandPlanPage.txt')
        pathDetail = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'Data/DatasupplyLandPlanDetail.csv')
        self.filePage = open(pathPage, 'w+')
        self.fileDetail = open(pathDetail, 'a+')
        self.fileDetail.write("""administration,supplyLandTitle,publishTime,fileTitle,totalSupplyLand,yearSupplyPlan,industrialLand,businessLand,totalHousionSupply,low_rentLand,affordableHousing,pengGaiLand,low_rentpengGaiLand,pengGaiAffordableHousing,pengGaiCommercialHousing,commercialHousing,ortherHousingLand,publicServiceLand,transportationLand,waterAreaLand,specialLand,publicRentalLand,limitCommercialLand,mediumCommercialLand,totalCommercialLand,commercialRatio, crawlingTime, url, md5Mark, \n""")
