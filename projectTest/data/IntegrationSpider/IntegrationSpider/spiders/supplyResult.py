...
class supplyResultSpider(CrawlSpider):
    ...
    def __init__(self):
        ...
        pathPage = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'Data/DataSupplyResultPage.txt')
        pathDetail = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'Data/DataSupplyResultDetail.csv')
