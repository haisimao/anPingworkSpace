...
class PDF(object):
    ...
    def download_pdf(self, pdf_url, path_main):
        """
        下载pdf文件
    ...
    def imgpdf_change_img_local(self, path, pic_path):
        """
        从pdf文件中提取图片
       :param path: pdf文件的路径
...
if __name__ == '__main__':
    url = 'http://www.czbank.com/cn/personal/investment/issue/201810/W020181024598761696142.pdf'
    path_main = r'C:\Users\lyial\Desktop\try_project\pdf_img_word\pdf_download'
    # PDF().download_pdf(url,path_main)
    ...
    pic_path = r'C:\Users\lyial\Desktop\img2'
    # PDF().imgpdf_change_img_local(path,pic_path)
