...
class GetJsEncryptPage(object):
    ...
    async def main(self, url, entityCode):  # 定义main协程函数，
        ...
        UA = random.choice(useragent.agent_list)
...
if __name__ == '__main__':
    ...
    referer = 'https://www.cqggzy.com/tiaozhuan.html?infoid=966ca2a9-f630-4a3a-a4d5-055b7463f0eb&categorynum=014004004'
    ...
    # data = FirefoxGetPage().work(referer)
    print(data)